...
function mymedi_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/redux-framework.4.3.20.zip'
            ,'required'           => true
			,'version'            => '4.3.20'
            ,'external_url'       => ''
        )
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.7.0.1.zip'
            ,'required'           => true
			,'version'            => '7.0.1'
            ,'external_url'       => ''
        )
		...
		,array(
            'name'                => 'Contact Form 7'
            ,'slug'               => 'contact-form-7'
			,'source'             => 'https://downloads.wordpress.org/plugin/contact-form-7.5.6.4.zip'
            ,'required'           => false
			,'version'            => '5.6.4'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.4.8.11.zip'
            ,'required'           => false
			,'version'            => '4.8.11'
            ,'external_url'       => ''
        )
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-compare.2.20.0.zip'
            ,'required'           => false
			,'version'            => '2.20.0'
            ,'external_url'       => ''
        )
