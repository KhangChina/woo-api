 ...
 * Description: Add shortcodes and custom post types for the MyMedi Theme
 * Version: 1.2.0
 * Author: ThemeSky Team
 * Author URI: http://theme-sky.com
 */
if( !defined('THEMESKY_VERSION') ){
	define('THEMESKY_VERSION', '1.2.0');
}

if( !defined('THEMESKY_DIR') ){
	define('THEMESKY_DIR', plugin_dir_path( __FILE__ ));
}
...
class ThemeSky_Plugin{
	...
	function register_widgets(){
		$file_names = array('single_image', 'twitter', 'mailchimp_subscription', 'product_filter_by_color', 'product_filter_by_availability'
							, 'product_filter_by_brand', 'product_filter_by_price', 'social_icons', 'products', 'blogs', 'related_products'
							, 'recent_comments', 'facebook_page', 'instagram', 'product_categories');
